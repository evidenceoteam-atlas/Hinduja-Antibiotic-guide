...
export default function App() {
  ...
  const login = () => {
    ...
    const isEmployeeId = /^[A-Za-z][A-Za-z0-9-]{2,}$/.test(loginIdentifier);

    if (loginIdentifier.length === 0 || password.length === 0) {
      setLoginError("Enter Hospital ID / Email and password.");
      return;
    }

    if (!isEmail && !isEmployeeId) {
      setLoginError("Enter a valid Hospital ID / Email.");
      return;
    }
  ...
  const PrimaryButton = ({
    ...
    <TouchableOpacity
      activeOpacity={0.88}
      onPress={onPress}
      style={[styles.primaryButton, red && styles.redButton]}
    >
    ...
    <View style={styles.centerScreen}>
      ...
      <View style={styles.inputWrap}>
        ...
        <TextInput
          ...
          accessibilityLabel="Hospital ID / Email"
          value={email}
          onChangeText={setEmail}
          placeholder="EMP12345 or doctor@hindujahospital.com"
      ...
      <View style={styles.inputWrap}>
        ...
        >
          <Text style={styles.passwordEyeIcon}>{showPassword ? "◉" : "⊘"}</Text>
        </TouchableOpacity>
      </View>
      <TouchableOpacity
        activeOpacity={0.82}
    ...
    <View style={styles.centerScreen}>
      ...
      <View style={styles.inputWrap}>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            setShowSignupPassword((previousValue) => !previousValue)
          }
          style={styles.passwordEyeButton}
        >
  ...
  const Otp = () => (
    <View style={styles.centerScreen}>
      ...
      <Text style={styles.otpSubtitle}>
        ...
        {email || signupEmail || "your registered contact"}
      </Text>
      ...
      <PrimaryButton label="Verify & Login" onPress={verifyOtp} />
      <View style={styles.infoBox}>
